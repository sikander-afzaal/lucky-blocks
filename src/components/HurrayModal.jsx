const HurrayModal = ({ setModal }) => {
  return (
    <>
      ...
      ></div>
      <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 px-5 pt-24 pb-6 w-full sm:max-w-[450px] flex justify-start max-h-full sm:max-h-[90%] overflow-y-auto bg-[#F1DEEB] z-[100] h-full sm:h-auto sm:rounded-2xl items-center overflow-hidden flex-col gap-2">
        {/* <img
          src="/blur.png"
